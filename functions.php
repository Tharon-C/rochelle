...
function load_fonts() {
            ...
            wp_register_style('open-sans', 'https://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,400,600,700');

            wp_enqueue_style( 'open-sans');



            wp_register_style('lato', 'https://fonts.googleapis.com/css?family=Lato:100,400,700,900,100italic,300italic,400italic,700italic,900italic');
            ...
            wp_register_style('font-awsome', 'https://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css');
